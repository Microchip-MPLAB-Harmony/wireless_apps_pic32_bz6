...
# device variant available
#   0: 512/96KB for Buckland; 2048/512KB for BigBuck
#   1: 256/64KB for Buckland; 1024/256KB for BigBuck
...
def header_copyright():
    print("Header GUI v1.22 (c) 7/9/2024 Microchip Technology All Rights Reserved")
    
def ota_copyright():
    print("Over The Air Package Maker GUI v1.18 (c) 7/16/2024 Microchip Technology All Rights Reserved")
...
def memory_addr_set():
    ...
    if global_flash_type == 0:
        if g_device_family == 1 or g_device_family == 2: 
        ...
        if global_slot_num == 0:
            ...
            if g_device_family == 1 or g_device_family == 2: 
                ...
                global_header_start_address=0x808000
                global_crop_start_address=0x808200
                g_img_src_addr=0x808200
                g_img_dst_addr=0x808200
        else:
...
def is_ipe():
    try:
        # this will throw an exception if active_config is not defined
        test_access = active_config
    except:
        return True
...
class HeaderPane():
    ...
    def initUI(self):
        ...
        flashTypeLabel = JLabel("Memory Type:")
        ...
        self.flashType_items = ("boot flash", "eflash", "RAM")
...
class flashTypeMouseListener(MouseAdapter):
    def mousePressed(self, event):
        JOptionPane.showMessageDialog(gframe, 
                              "Memory type of the target application is the choice of boot flash eflash or RAM", 
                              "Flash Type Help", 
    ...
    def CreateOTAFile(self, event):
        ...
        with open(project_root_path+"\\"+g_cfg_outputfile, "wb") as fb:
            ...
            if g_device_family == 0:
                ...
                crc_buf = g_metaheader[32:]
            elif g_device_family == 3:
                crc_buf = g_metaheader[64:]
            g_img_src_addr = tmp_src
            fill_header()
